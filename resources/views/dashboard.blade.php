...
<div class="min-h-screen bg-gradient-to-br from-teh-jawa-cream via-white to-teh-jawa-gold-accent/20">
    <div class="container mx-auto px-3 sm:px-4 py-4 md:py-6 max-w-7xl">
        
        <!-- Header -->
        <div class="mb-4 md:mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-teh-jawa-gold to-teh-jawa-brown bg-clip-text text-transparent mb-1">Dashboard</h1>
                    <p class="text-xs sm:text-sm text-teh-jawa-gray">Kelola keuangan & pesanan Teh Jawa Anda</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4 md:mb-6">
            <h2 class="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-teh-jawa-gold to-teh-jawa-brown bg-clip-text text-transparent mb-3 flex items-center gap-2">
                <span class="w-1 h-6 md:h-8 bg-gradient-to-b from-teh-jawa-gold to-teh-jawa-brown rounded-full"></span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                ...
                <a href="{{ route('transactions.index', ['type' => 'income']) }}" class="block group">
                    <div class="card-teh-luxury p-4 md:p-5 border-l-4 border-teh-jawa-green hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                        <div class="flex items-center justify-between mb-2 md:mb-3">
                            <span class="text-xs md:text-sm font-semibold text-teh-jawa-green uppercase tracking-wide">Pemasukan</span>
                            <div class="bg-teh-jawa-green/10 p-2 md:p-3 rounded-lg group-hover:bg-teh-jawa-green/20 transition-colors">
                                <svg class="w-5 h-5 md:w-6 md:h-6 text-teh-jawa-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('transactions.index', ['type' => 'expense']) }}" class="block group">
                    <div class="card-teh-luxury p-4 md:p-5 border-l-4 border-red-500 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                        <div class="flex items-center justify-between mb-2 md:mb-3">
                            <span class="text-xs md:text-sm font-semibold text-red-600 uppercase tracking-wide">Pengeluaran</span>
                            <div class="bg-red-100 p-2 md:p-3 rounded-lg group-hover:bg-red-200 transition-colors">
                ...
                <!-- Profit Card -->
                <a href="{{ route('reports.index') }}" class="block group sm:col-span-2 lg:col-span-1">
                    <div class="card-teh-luxury p-4 md:p-5 border-l-4 {{ $monthlyProfit >= 0 ? 'border-teh-jawa-gold' : 'border-red-500' }} hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                        <div class="flex items-center justify-between mb-2 md:mb-3">
                            <span class="text-xs md:text-sm font-semibold {{ $monthlyProfit >= 0 ? 'text-teh-jawa-gold' : 'text-red-600' }} uppercase tracking-wide">Laba Bersih</span>
                            <div class="{{ $monthlyProfit >= 0 ? 'bg-teh-jawa-gold/10' : 'bg-red-100' }} p-2 md:p-3 rounded-lg group-hover:{{ $monthlyProfit >= 0 ? 'bg-teh-jawa-gold/20' : 'bg-red-200' }} transition-colors">
                                <svg class="w-5 h-5 md:w-6 md:h-6 {{ $monthlyProfit >= 0 ? 'text-teh-jawa-gold' : 'text-red-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-4 md:mb-6">
            <h2 class="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-teh-jawa-gold to-teh-jawa-brown bg-clip-text text-transparent mb-3 flex items-center gap-2">
                <span class="w-1 h-6 md:h-8 bg-gradient-to-b from-teh-jawa-gold to-teh-jawa-brown rounded-full"></span>
                Diagram Keuangan 30 Hari
            </h2>
            
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-4">
                <!-- Line Chart - Income vs Expense -->
                <div class="card-teh-luxury p-3 md:p-4">
                    <h3 class="text-sm md:text-base font-semibold bg-gradient-to-r from-teh-jawa-gold to-teh-jawa-brown bg-clip-text text-transparent mb-2 md:mb-3">Pemasukan vs Pengeluaran</h3>
                ...
                <div class="card-teh-luxury p-3 md:p-4">
                    <h3 class="text-sm md:text-base font-semibold bg-gradient-to-r from-teh-jawa-gold to-teh-jawa-brown bg-clip-text text-transparent mb-2 md:mb-3">Rincian Pengeluaran</h3>
                    <div class="relative h-48 sm:h-56 md:h-64 lg:h-72">

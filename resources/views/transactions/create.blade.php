...
<div class="min-h-screen bg-gradient-to-br from-teh-jawa-cream via-white to-teh-jawa-gold-accent/20">
    <div class="container mx-auto px-4 py-6 md:py-8 max-w-2xl">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold text-teh-jawa-black mb-2">Tambah Transaksi</h1>
            <p class="text-teh-jawa-gray">Catat pemasukan atau pengeluaran bisnis Anda</p>
        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="relative">
                            <input type="radio" name="category" value="income" class="peer sr-only" {{ old('category') == 'income' ? 'checked' : '' }}>
                        ...
                        <label class="relative">
                            <input type="radio" name="category" value="expense" class="peer sr-only" {{ old('category') == 'expense' ? 'checked' : '' }}>
